    ...
    <DayPicker
      ...
      classNames={{
        ...
        nav_button: cn(
          ...
          "h-7 w-7 bg-white dark:bg-input rounded-full p-0 opacity-80 hover:opacity-100"
        ),
        ...
        day: cn(
          ...
          "h-9 w-9 p-0 font-normal aria-selected:opacity-100 rounded-full hover:bg-primary-light/30"
        ),
